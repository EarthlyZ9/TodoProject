...
@app.post("/todos/", status_code=status.HTTP_201_CREATED, tags=['Todos'], response_model=Todo)
...
@app.get("/todos/{todo_id}", status_code=status.HTTP_200_OK, tags=['Todos'], response_model=Todo)
...
@app.patch("/todos/{todo_id}", status_code=status.HTTP_200_OK, tags=['Todos'], response_model=Todo)
